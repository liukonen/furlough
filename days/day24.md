...
- [video 2](https://channel9.msdn.com/Series/Web-API-Design/02)
    - Idea of having put or modifications wraped in a transaction or separate object, to enforce validation on objects
    -really nice tool you can include with your API. Web API 2.2 Help page
        -generates documentation for your api
        - a nugget package you can add
        - powered by MVC, so those decencies need to exist
        
- Took a small break, as someone on Slack pointed out a webinar on UX design, which really has been a week spot of mine, I think
    - [DataArt Webinar](https://www.dataart.com/industry/events/free-ux-webinar-best-tools-tips-and-tricks-for-the-fast-virtual-creation-of-ux-concepts). Best tools, tips, & tricks for the fast (virtual) creation of UX concepts 
        ...
        - a lot of it is powered by knowledge gathering and wire framing
...
- [video 3](https://channel9.msdn.com/Series/Web-API-Design/03)
    - really cool, you can have custom formatters on your response objects, by changing your request type (my one app at work has a different API call, but could try changing it to this)
...
- [video 4](https://channel9.msdn.com/Series/Web-API-Design/04)
    ...
    - whitelist rather then blacklist items part of request
    - there are built in helper classes for responses / confilts, etc
    - you can have sepcial exception messages that are reusable
